...
ASK_ROLE_MODE = (
    "🎛 <b>نحوهٔ دریافت نقش</b>\n\n"
    "می‌خواهید بازیکنان چگونه نقش خود را بگیرند؟\n\n"
    "⚡️ <b>نقش فوری هنگام ورود</b>: هر بازیکن به‌محض ورود، بلافاصله یک شماره و "
    "یک نقش تصادفی می‌گیرد و نقشش را می‌بیند — بدون انتظار برای بقیه.\n\n"
    "🔢 <b>نوبتی (کلاسیک)</b>: ابتدا همه وارد می‌شوند، سپس به‌ترتیب هرکس شماره "
    "انتخاب می‌کند و نقش می‌گیرد."
)
